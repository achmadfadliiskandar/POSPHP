...
if (isset($_POST['simpanuser'])) {
    ...
    $_SESSION['success'] = "User berhasil di tambahkan";
...
<input type="text" min="1" class="form-control" id="password" name="password">
</div>
...
<button type="submit" name="simpanuser" class="btn btn-primary my-3">Submit</button>
</form>
</div>
